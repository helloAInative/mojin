...
- 技术信号历史逐日回测，包含交易成本、命中率、复合收益、基准差额与最大回撤
- 模拟撮合：整手买入、T+1 可卖、涨跌停、佣金、印花税和过户费
- 持仓行情标记、每日权益快照及相邻快照收益
- 自选组和指数池维护
- 桌面端自选分组、一键技术扫描并直达五路 AI 候选排名
- 桌面端成交汇总、指数池与聚合美股、行业、信号、后验的每日复盘
- 新闻、昨日美股、行业板块、技术指标与历史后验驱动的研究候选池
- 五角色 OpenAI 兼容模型并行分析、加权仲裁、用量记录与逐路本地降级
- 基于波动率、ATR 和模拟权益 1% 风险预算的候选仓位与止损止盈参考
- 研究风险计划随模拟买单保存，风险中心用最新行情跟踪止损、止盈和未配置持仓
